          ...
          <div class="header__left-menu left-menu">
            ...
            <div class="left-menu__btns">
              <div class="left-menu__btn">
                <AlBtn 
                  @click="this.toggleStateViewsBooksOnArchive"
                  :authBtnName="btnNameArchive"
                  :activeBtn="this.getStateViewsBooks"
                />
              </div>
              <div class="left-menu__btn">
                <AlBtn 
                  @click="this.toggleStateViewsBooksOnAll"
                  :authBtnName="btnNameAllBook"
                  :activeBtn="!this.getStateViewsBooks"
                />
              </div>
              
              <!-- <button class="left-menu__btn-my-books">Мои книги</button>
              <button class="left-menu__btn-archive">Архив</button> -->
            </div>
          </div>
...
export default {
  ...
  data: () => ({
    btnNameArchive: 'Архив',
    btnNameAllBook: 'Мои книги',
  ...
  computed: {
    ...mapGetters({
      getStateViewsBooks: 'books/getStateViewsBooks'
    }),
    
  },
  methods: {
    ...mapMutations({
      toggleStateViewsBooksOnArchive: 'books/ARCHIVE_STATE_VIEWS_BOOKS',
      toggleStateViewsBooksOnAll: 'books/ALL_STATE_VIEWS_BOOKS',
    }),
  }
}
</script>
